    ...
    <div class="flex items-center justify-between mb-8">
        <div>
            ...
            <p class="text-gray-500 dark:text-gray-400 font-medium text-sm transition-colors">
                Daftarkan penghuni baru dengan integrasi Telegram Bot.
            </p>
        </div>
        ...
        <form action="{{ route('tenants.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                ...
                <div class="space-y-2">
                    ...
                    <input type="text" name="telegram_chat_id" placeholder="Contoh: 12345678"
                    ...
                    <p class="text-[9px] text-gray-400 dark:text-gray-500 italic ml-1 tracking-tight">
                        * Dapatkan ID dengan chat <b>@userinfobot</b> di Telegram.
                    </p>
                </div>
                ...
                <div class="md:col-span-2 space-y-2">
                    ...
                    <select name="room_id"
                        ...
                        @else
                            ...
                            @foreach($rooms as $r)
                                <option value="{{ $r->id }}">
                                    Kamar {{ $r->room_number }} ({{ $r->type }}) - Rp {{ number_format($r->price) }}
                                </option>
                            @endforeach
                        @endif
                    </select>
