            ...
            <form action="{{ route('rooms.store') }}" method="POST">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                    <input type="text" name="room_number" placeholder="No. Kamar (A-01)"
                        class="p-4 bg-gray-50 border border-gray-100 rounded-2xl focus:ring-4 focus:ring-blue-100 outline-none transition font-bold"
                        required>

                    <select name="type"
                        class="p-4 bg-gray-50 border border-gray-100 rounded-2xl focus:ring-4 focus:ring-blue-100 outline-none transition font-bold text-gray-500"
                        required>
                    ...
                    <div class="relative">
                        ...
                        <input type="number" name="price" placeholder="Harga"
                            class="w-full p-4 pl-12 bg-gray-50 border border-gray-100 rounded-2xl focus:ring-4 focus:ring-blue-100 outline-none transition font-bold"
                            required>
                    </div>

                    <button type="submit"
                        class="bg-blue-600 text-white rounded-2xl font-black text-xs uppercase tracking-widest hover:bg-blue-700 shadow-lg shadow-blue-100 transition active:scale-95">
                        Tambah Kamar
                    </button>
                </div>
            </form>
                    ...
                    <tbody class="divide-y divide-gray-50">
                        @foreach($rooms as $room)
                            <tr class="hover:bg-gray-50/50 transition group">
                                <td class="p-6">
                                    <span
                                        class="bg-blue-50 text-blue-700 px-3 py-1.5 rounded-lg font-black text-sm tracking-tight">
                                        {{ $room->room_number }}
                                    </span>
                                </td>
                                <td class="p-6">
                                ...
                                <td class="p-6">
                                    <div class="flex justify-center items-center gap-2">
                                        <a href="{{ route('rooms.edit', $room->id) }}"
                                            class="inline-flex items-center gap-1.5 bg-blue-50 text-blue-600 hover:bg-blue-100 px-3 py-2 rounded-xl text-[10px] font-black uppercase tracking-widest transition">
